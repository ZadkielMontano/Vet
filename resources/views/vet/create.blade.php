...
<div class="card shadow">
    <div class="card-header border-0">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="mb-0">Nuevo veterinario</h3>
            </div>
    ...
    @if($errors->any())
        ...
        <form action="{{url('/veterinarios')}}" method="POST">
            @csrf
            <div class="form-group">
                <label for="name">Nombre del  veterinario</label>
            ...
            <button type="submit" class="btn btn-sm btn-primary">Crear nuevo veterinario</button>
        </form>
    </div>
</div>
