        ...
        <form action="{{url('/reservarcitas')}}" method="POST">
            ...
            <div class="custom-control custom-radio mt-3 mb-3">
                ...
                <div class="custom-control custom-radio mb-3">
                    ...
                    <label class="custom-control-label" for="type2">Vacunación</label>
                </div>
            ...
            <div class="form-group">
                ...
                <textarea  name="description" id="description" type="text" class="form-control" rows="5" placeholder="Descripción breve" required>
